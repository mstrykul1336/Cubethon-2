...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void EndTrigger_OnTriggerEnter_m27A2D784A2AEF49D2075616CCB5BF73179E64A4C (EndTrigger_tE063DD4579986D8BF8D45E6704B0D27BCE984BFB* __this, const RuntimeMethod* method) 
{
	{
...
{
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_0 = __this->___completeLevelUI_6;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void GameManager_EndGame_m280CB4AB8F3243752E42BBAE128D1ABC092E6D62 (GameManager_tFE129A0017AF5BBD30FDCD4403B9CCEAE064C6B6* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		bool L_0 = __this->___gameHasEnded_4;
		if (L_0)
		{
			goto IL_0020;
		}
	...
	{
		// gameHasEnded = true;
		__this->___gameHasEnded_4 = (bool)1;
		// Invoke("Restart", restartDelay);
		float L_1 = __this->___restartDelay_5;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerCollision_OnCollisionEnter_m58A1F3B128D352BE0F7FA2ACFB9C397F4B1D927E (PlayerCollision_t7BF0F4C2A506987589B3E5E8938A76977B0051B1* __this, Collision_tBCC6AEBD9A63E6DA2E50660DAC03CDCB1FF7A9B0* ___collisionInfo0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		bool L_3;
		L_3 = String_op_Equality_m030E1B219352228970A076136E455C4E568C02C1(L_2, _stringLiteral4A34B70F6AD38F74965ACAD911125EDA9537B07E, NULL);
		if (!L_3)
		{
			goto IL_002d;
		}
	}
	{
		...
		PlayerMovement_t4A0A0A8C937BC1D4FC570D1B5B50847338423351* L_4 = __this->___movement_4;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerMovement_FixedUpdate_m05F06EBAEB85F1B860ED042B83AD54F61DC53EFE (PlayerMovement_t4A0A0A8C937BC1D4FC570D1B5B50847338423351* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		float L_5 = __this->___sidewaysForce_6;
		float L_6;
...
IL_004f:
	...
	}
	{
		...
		float L_9 = __this->___sidewaysForce_6;
		float L_10;
...
IL_007e:
	...
	}
	{
		...
		GameManager_EndGame_m280CB4AB8F3243752E42BBAE128D1ABC092E6D62(L_14, NULL);
	}
...
{
	{
		...
		__this->___forwardForce_5 = (2000.0f);
		// public float sidewaysForce = 500f;
		__this->___sidewaysForce_6 = (500.0f);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
